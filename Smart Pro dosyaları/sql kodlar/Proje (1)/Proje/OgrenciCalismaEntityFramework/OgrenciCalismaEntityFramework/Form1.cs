...
namespace OgrenciCalismaEntityFramework
{
    public partial class Form1 : Form
    {
        ...
        {
            con = new SqlConnection("Data Source=KRALMACHINE;Initial Catalog=OrnekCalisma;Integrated Security=SSPI;");
        ...
        {
            entity.DoktorID = Convert.ToInt16(txtDoktorID.Text);
            entity.HastaID = Convert.ToInt16(txtHastaID.Text);
