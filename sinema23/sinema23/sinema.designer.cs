...
namespace sinema23
{
    ...
    partial void InsertFimYayin(FimYayin instance);
    partial void UpdateFimYayin(FimYayin instance);
    partial void DeleteFimYayin(FimYayin instance);
    ...
    partial void DeleteFilm(Film instance);
		...
		public sinemaDataContext() : 
				base(global::sinema23.Properties.Settings.Default.sinemaConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<FimYayin> FimYayins
		{
			get
			{
				return this.GetTable<FimYayin>();
			}
		}
	...
	public partial class Salon : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<FimYayin> _FimYayins;
    ...
    partial void OnSalonAdiChanged();
		...
		public Salon()
		{
			this._FimYayins = new EntitySet<FimYayin>(new Action<FimYayin>(this.attach_FimYayins), new Action<FimYayin>(this.detach_FimYayins));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Salon_FimYayin", Storage="_FimYayins", ThisKey="SalonID", OtherKey="SalonID")]
		public EntitySet<FimYayin> FimYayins
		{
			get
			{
				return this._FimYayins;
			}
			set
			{
				this._FimYayins.Assign(value);
			}
		}
		...
		private void attach_FimYayins(FimYayin entity)
		{
			this.SendPropertyChanging();
			entity.Salon = this;
		}
		
		private void detach_FimYayins(FimYayin entity)
		{
			this.SendPropertyChanging();
			entity.Salon = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.FimYayin")]
	public partial class FimYayin : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnFYZamanChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Salon_FimYayin", Storage="_Salon", ThisKey="SalonID", OtherKey="SalonID", IsForeignKey=true)]
		public Salon Salon
		{
			get
			{
			...
			set
			{
							...
							|| (this._Salon.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.FimYayins.Remove(this);
					}
					this._Salon.Entity = value;
					if ((value != null))
					{
						value.FimYayins.Add(this);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Film_FimYayin", Storage="_Film", ThisKey="FilmID", OtherKey="FilmID", IsForeignKey=true)]
		public Film Film
		{
			get
			{
    ...
    partial void OnFilmAdiChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Film_FimYayin", Storage="_FimYayins", ThisKey="FilmID", OtherKey="FilmID")]
		public EntitySet<FimYayin> FimYayins
		{
			get
			{
